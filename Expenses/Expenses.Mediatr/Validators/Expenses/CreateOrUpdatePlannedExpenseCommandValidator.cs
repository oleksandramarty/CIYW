...
public class CreateOrUpdatePlannedExpenseCommandValidator: AbstractValidator<CreateOrUpdatePlannedExpenseCommand>
{
    public CreateOrUpdatePlannedExpenseCommandValidator()
    {
        RuleFor(x => x.Title)
