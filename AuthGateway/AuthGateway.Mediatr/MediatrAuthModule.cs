...
public class MediatrAuthModule: Autofac.Module
{
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.RegisterAssemblyTypes(typeof(UpdateUserSettingCommand).GetTypeInfo().Assembly).AsClosedTypesOf(typeof(IRequestHandler<>));
        ...
        builder.RegisterAssemblyTypes(typeof(GetCurrentUserRequest).GetTypeInfo().Assembly).AsClosedTypesOf(typeof(IRequestHandler<>));
    }
}