...
public class AuthLoginRequestHandler: IRequestHandler<AuthLoginRequest, JwtTokenResponse>
{
    ...
    public AuthLoginRequestHandler(
    ...
    public async Task<JwtTokenResponse> Handle(AuthLoginRequest request, CancellationToken cancellationToken)
    {
