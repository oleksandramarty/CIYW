...
import {
    selectIsAdmin, selectIsAdminAreaAvailable,
    selectIsSuperAdmin,
    selectIsTechnicalSupport,
    selectIsUser,
    selectToken
...
export class AuthService {
    ...
    private _isTechnicalSupport$: Observable<boolean | undefined> | undefined;
    private _isAdminAreaAvailable$: Observable<boolean | undefined> | undefined;
    ...
    constructor(
        ...
        this._isTechnicalSupport$ = this.store.select(selectIsTechnicalSupport);
        this._isAdminAreaAvailable$ = this.store.select(selectIsAdminAreaAvailable);
    }
