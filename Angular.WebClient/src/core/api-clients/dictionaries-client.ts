...
export class DictionaryClient {
    ...
    dictionary_GetCountries(request: GetCountriesRequest): Observable<VersionedListResponseOfCountryResponse> {
    ...
    dictionary_GetCurrencies(request: GetCurrenciesRequest): Observable<VersionedListResponseOfCurrencyResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<VersionedListResponseOfCurrencyResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<VersionedListResponseOfCurrencyResponse>;
        }));
    }

    protected processDictionary_GetCurrencies(response: HttpResponseBase): Observable<VersionedListResponseOfCurrencyResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 400) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = VersionedListResponseOfCurrencyResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    dictionary_GetCategories(request: GetCategoriesRequest): Observable<VersionedListResponseOfTreeNodeResponseOfCategoryResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<VersionedListResponseOfTreeNodeResponseOfCategoryResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<VersionedListResponseOfTreeNodeResponseOfCategoryResponse>;
        }));
    }

    protected processDictionary_GetCategories(response: HttpResponseBase): Observable<VersionedListResponseOfTreeNodeResponseOfCategoryResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 400) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = VersionedListResponseOfTreeNodeResponseOfCategoryResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    dictionary_GetFrequencies(request: GetFrequenciesRequest): Observable<VersionedListResponseOfFrequencyResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<VersionedListResponseOfFrequencyResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<VersionedListResponseOfFrequencyResponse>;
        }));
    }

    protected processDictionary_GetFrequencies(response: HttpResponseBase): Observable<VersionedListResponseOfFrequencyResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 400) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = VersionedListResponseOfFrequencyResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
