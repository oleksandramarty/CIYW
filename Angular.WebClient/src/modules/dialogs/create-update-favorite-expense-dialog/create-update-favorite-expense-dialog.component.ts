...
@Component({
    ...
    templateUrl: './create-update-favorite-expense-dialog.component.html',
    styleUrl: './create-update-favorite-expense-dialog.component.scss'
})
export class CreateUpdateFavoriteExpenseDialogComponent extends BaseUnsubscribeComponent {
    ...
    constructor(
        public dialogRef: MatDialogRef<CreateUpdateFavoriteExpenseDialogComponent>,
