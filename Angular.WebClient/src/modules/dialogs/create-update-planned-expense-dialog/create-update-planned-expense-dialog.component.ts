...
@Component({
    ...
    templateUrl: './create-update-planned-expense-dialog.component.html',
    styleUrl: './create-update-planned-expense-dialog.component.scss'
})
export class CreateUpdatePlannedExpenseDialogComponent extends BaseUnsubscribeComponent {
    ...
    constructor(
        public dialogRef: MatDialogRef<CreateUpdatePlannedExpenseDialogComponent>,
