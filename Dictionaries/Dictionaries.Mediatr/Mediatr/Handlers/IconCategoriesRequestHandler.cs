...
{
    private readonly IDictionaryRepository<int, IconCategoryEntity, IconCategoryResponse, DictionariesDataContext> _dictionaryRepository;
    ...
    {
        VersionedListResponse<IconCategoryResponse> response = await _dictionaryRepository.DictionaryAsync(
            request.Version,
            cancellationToken,
