...
public class GetFilteredResultOfAuditTrailStrategy :
    GetFilteredResultStrategyResponseContext<GetFilteredAuditTrailRequest, AuditTrailEntity, AuditTrailResponse>,
    IGetFilteredResultStrategy<GetFilteredAuditTrailRequest, AuditTrailResponse>
{
    private readonly IReadGenericRepository<Guid, AuditTrailEntity, AuditTrailDataContext> auditTrailRepository;

    public GetFilteredResultOfAuditTrailStrategy(
        IMapper mapper,
    ...
    public async Task<FilteredListResponse<AuditTrailResponse>> GetFilteredResultAsync(
        GetFilteredAuditTrailRequest request, CancellationToken cancellationToken)
    {
        var query = this.auditTrailRepository.GetQueryable(e =>
            (
