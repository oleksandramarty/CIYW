...
public static class GraphQlExtension
{
        ...
        where TFilter: IBaseFilterRequest, new ()
    {
        ...
        if (query is FilteredPlannedExpensesRequest plannedExpensesRequest)
        {
        ...
        if (query is FilteredFavoriteExpensesRequest favoriteExpensesRequest)
        {
        ...
        if (query is FilteredAuditTrailRequest auditTrailRequest)
        {
